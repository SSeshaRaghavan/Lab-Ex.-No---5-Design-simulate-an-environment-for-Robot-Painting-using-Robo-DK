...
def MainProgram():
  ...
  def Prog1():
    ...
    movej([-0.000293, -1.570730, -1.575092, 0.004229, 1.571090, -0.000000],accel_radss,speed_rads,0,0.001)
    movej([0.610865, -1.678134, -1.264142, -1.369036, 2.110452, 0.536514],accel_radss,speed_rads,0,0.001)
    movej([0.584521, -2.035002, -1.354739, -1.168491, 1.537850, 0.845010],accel_radss,speed_rads,0,0.001)
    movel(pose_trans(ref_frame,p[0.094715, 0.360319, 0.042839, 1.683762, -2.275333, 0.516722]),accel_mss,speed_ms,0,0.001)
    movej([0.172578, -1.891326, -1.718186, -0.836297, 2.017356, 0.558237],accel_radss,speed_rads,0,0.001)
    movel(pose_trans(ref_frame,p[0.072143, 0.183220, 0.018463, 1.829161, -2.547955, 0.010986]),accel_mss,speed_ms,0,0.001)
    movel(pose_trans(ref_frame,p[0.096960, 0.050270, 0.045097, -1.749948, 2.455100, 0.247529]),accel_mss,speed_ms,0,0.001)
    movel(pose_trans(ref_frame,p[0.334678, 0.044539, 0.043930, -1.749948, 2.455100, 0.247529]),accel_mss,speed_ms,0,0.001)
  end
  
  # Subprogram retractmove
  def retractmove():
    movej([0.193033, -1.695587, -1.257335, -1.386490, 2.110452, 0.536514],accel_radss,speed_rads,0,0.001)
    movej([-0.000293, -1.570730, -1.575092, 0.004229, 1.571090, -0.000000],accel_radss,speed_rads,0,0.001)
  end
  
  
  # Main program:
  # Program generated by RoboDK v5.9.0 for UR10e on 02/05/2025 14:40:18
...
## Results of simulation :
 ![Screenshot 2025-05-02 144810](https://github.com/user-attachments/assets/a327e65d-62c3-434a-bbf8-9637edfa381a)
